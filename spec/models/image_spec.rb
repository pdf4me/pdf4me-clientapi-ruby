...
# Unit tests for Pdf4me::Image
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Image' do
  before do
    # run before each test
    @instance = Pdf4me::Image.new
  end
  ...
  describe 'test an instance of Image' do
    it 'should create an instance of Image' do
      expect(@instance).to be_instance_of(Pdf4me::Image)
    end
  end
  ...
  describe 'test attribute "compression"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cCITTFax", "flate", "dCT"])
