...
module Pdf4me
  ...
  class Split
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SplitAction')
        self.split_action = attributes[:'SplitAction']
      end
    ...
    def hash
      [document, split_action, notification].hash
    end
