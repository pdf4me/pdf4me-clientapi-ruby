...
module Pdf4me
  ...
  class DocLog
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'docLogLevel')
        self.doc_log_level = attributes[:'docLogLevel']
      end
    ...
    def valid?
      doc_log_level_validator = EnumAttributeValidator.new('String', ["verbose", "info", "warning", "error", "timing"])
      return false unless doc_log_level_validator.valid?(@doc_log_level)
      return true
    end
    ...
    def hash
      [message_type, message, timestamp, doc_log_level, duration_milliseconds].hash
    end
