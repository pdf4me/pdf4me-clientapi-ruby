...
module Pdf4me
  ...
  class Notification
    ...
    attr_accessor :get_notification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'getNotification')
        self.get_notification = attributes[:'getNotification']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          get_notification == o.get_notification &&
    ...
    def hash
      [get_notification, connection_id].hash
    end
