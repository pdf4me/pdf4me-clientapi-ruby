...
module Pdf4me
  ...
  class Page
    ...
    attr_accessor :source_page_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sourceDocumentId')
        self.source_document_id = attributes[:'sourceDocumentId']
      end

      if attributes.has_key?(:'sourcePageNumber')
        self.source_page_number = attributes[:'sourcePageNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_page_number == o.source_page_number
    end
    ...
    def hash
      [document_id, page_id, page_number, rotate, thumbnail, source_document_id, source_page_number].hash
    end
